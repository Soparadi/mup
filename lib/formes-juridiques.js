// Nomenclature INSEE des categories juridiques, niveau III.
// Source officielle : https://xml.insee.fr/schema/cj-enum.html
// NE PAS editer de memoire : toute correction doit venir de la source INSEE.
//
// Le code 1000 (« Entrepreneur individuel ») releve du niveau II mais est
// conserve ici car SIRENE l'emet en pratique pour les EI / independants.
...
export function libelleFormeJuridique(code) {
  return FORMES_JURIDIQUES[code] || String(code || '');
}
