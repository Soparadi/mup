...
// logos parfaitement ordinaires, puisque la toile encode plus de trois fois
// plus de pixels.
//     709 × 240 = 170 160 pixels
//     320 × 160 =  51 200 pixels
//     rapport   = 3,3234
//     300 Ko × 3,3234 = 997 Ko, arrondis à 1 000 Ko.
// LA SECONDE ROUTE DONNE LE MÊME RÉSULTAT, et c'est ce qui autorise l'arrondi :
// rapportée non plus à la signature de courriel mais au plafond qui était en
// place, la surface passe de 709 × 177 à 709 × 240, soit
//     170 160 ÷ 125 493 = 1,3559  et  750 Ko × 1,3559 = 1 017 Ko.
// Les deux chemins tombent sur mille kilooctets, l'un par en dessous, l'autre
// par au-dessus.
...
// logo. En adresse data:, 1 000 Ko encodés font environ 1,33 Mo transmis, la
// base64 pesant un tiers de plus que les octets qu'elle porte, et le parseur
// global de 10 Mo (server.js) les porte sans qu'on lui pose de limite propre.
export const LOGO_OCTETS_MAX = 1000 * 1024
